    ...
    <>
      <style>{`
        .uiverse-btn {
          position: relative;
          padding: 10px 28px;
          background: #c8a96e; /* gold theme color matching Niyat Somsa */
          font-size: 13px;
          font-weight: 700;
          color: #1a1614;
          cursor: pointer;
          ...
          overflow: hidden; /* keeping leaves inside */
        }
        ...
        @keyframes soft-glow {
          ...
          50% {
            box-shadow: 0 0 12px rgba(200, 169, 110, 0.7), 0 0 4px rgba(200, 169, 110, 0.3);
          }
          100% {
            box-shadow: 0 0 4px rgba(200, 169, 110, 0.3);
          }
